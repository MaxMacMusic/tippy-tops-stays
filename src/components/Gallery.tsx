...
import entranceGate from "@/assets/entrance-gate.png";
import tinyHouseFirepit from "@/assets/tiny-house-firepit.png";
import propertyAerial from "@/assets/property-aerial.png";

const shots = [
  { src: tinyHouseFirepit, alt: "The Sunset Shanty tiny house overlooking the firepit and green hillside", span: "md:col-span-2 md:row-span-2" },
  { src: propertyAerial, alt: "Aerial view of The Sunset Shanty tiny house and its secluded hinterland setting", span: "md:col-span-2" },
  { src: entranceGate, alt: "Country entrance gate leading toward The Sunset Shanty", span: "" },
